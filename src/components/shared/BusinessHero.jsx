  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-50 to-white min-h-[600px] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Design Tools - Left Bottom */}
        <div className="absolute left-8 bottom-16 space-x-2 flex items-center">
      ...
      {/* Bottom Banner */}
      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-r from-purple-600 to-purple-700 py-4 overflow-hidden">
